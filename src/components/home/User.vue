...
<body>
  <el-container>
    ...
    <el-container>
      <el-main>
        <div id="div_login">
          <div id="div_title"><h1>普通用户登录</h1></div>
          ...
          <div id="midden">
            ...
            <el-button @click="submitForm('ruleForm')" value="登录" class="submitbutton_login" type="warning">登录</el-button>
            <el-button @click="handleCommand()" value="注册" class="submitbutton_registered" type="warning">注册</el-button>
          </div>
        </div>
    </el-main>
  </el-container>
